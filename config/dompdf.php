...
return [
    ...
    */
    ...
    'options' => [
         ...
         * Symbol, ZapfDingbats.
         */
        'font_dir' => public_path('fonts\static\Cairo-light.ttf'), // advised by dompdf (https://github.com/dompdf/dompdf/pull/782)
        // 'font_dir' => storage_path('fonts\Cairo-VariableFont_slnt,wght.ttf'), // advised by dompdf (https://github.com/dompdf/dompdf/pull/782)
         ...
         * Note: This directory must exist and be writable by the webserver process.
         */
        'font_cache' => public_path('fonts\Cairo-VariableFont_slnt,wght.ttf'),
